...
public class SpeedModule extends Module {
    public SpeedModule(BypassProfileRepository repository) {
        ...
        List<String> modes = repository.loadModes("movement", "speed", List.of("Grimm", "Matrix", "FunTime", "Slot AC", "Hop", "Water", "Коллизия", "Блоки"));
        ...
        repository.registerDynamicSettings(this, "movement", "speed");
        repository.applyValueOverrides(this, "movement", "speed");
    }
}
