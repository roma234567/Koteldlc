...
public class AttackAuraModule extends Module {
    public AttackAuraModule(BypassProfileRepository repository) {
        ...
        List<String> rotationModes = repository.loadModes("combat", "killaura", List.of("Grimm", "Matrix", "FunTime", "Slot AC", "Резкая", "Плавная", "Snap", "FunTime snap"));
        ...
        repository.registerDynamicSettings(this, "combat", "killaura");
        repository.applyValueOverrides(this, "combat", "killaura");
    }
}
